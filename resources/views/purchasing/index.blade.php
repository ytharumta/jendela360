...
@section('pagetitledes')
    You have {{$total}} total Purchasing.
@endsection
...
<div class="card card-bordered card-preview">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#tabItem1">List Purchase</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tabItem2">Create Purchase</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="tabItem2">
                <div class="card-inner">
                    <form id="purchaseStore" action="{{route('purchasing.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-label" for="full-name-1">Purchase Number</label>
                                    <div class="form-control-wrap">
                                        <input type="text" name='po_number' class="form-control" id="full-name-1" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-label" for="email-address-1">Vendor Name</label>
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" name="vendor_name" id="email-address-1" value='' required>
                                    </div>
                                </div>
                            </div>
                            <br>
