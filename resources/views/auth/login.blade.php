                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des">
                                <p>Access the Jendela360 panel using your email and passcode.</p>
                            </div>
                        </div>
                    </div><!-- .nk-block-head -->
                    <form id="login" method="POST" action="{{route('signin')}}">
                    @csrf
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg @error('email') is-invalid @enderror" id="default-01" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Enter your email address or username">
